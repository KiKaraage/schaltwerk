            ...
            <div>
                ...
                <div className="space-y-3 mb-4">
                    ...
                    <div className="text-sm">
                        ...
                        <ul className="list-disc pl-6 mt-1 space-y-1">
                            <li><kbd className="px-1 py-0.5 bg-slate-700 rounded text-xs">⌘←</kbd> Switch to previous project</li>
                            <li><kbd className="px-1 py-0.5 bg-slate-700 rounded text-xs">⌘→</kbd> Switch to next project</li>
                        </ul>
                    </div>
                    <div className="text-sm">
                        ...
                        <ul className="list-disc pl-6 mt-1 space-y-1">
                            ...
                            <li><kbd className="px-1 py-0.5 bg-slate-700 rounded text-xs">⌘S</kbd> Convert session to spec</li>
                            <li><kbd className="px-1 py-0.5 bg-slate-700 rounded text-xs">⌘⇧S</kbd> Enter spec mode (orchestrator)</li>
                        </ul>
                    </div>
                </div>
                <p className="text-sm text-slate-400">
