...
impl std::fmt::Display for SettingsServiceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            SettingsServiceError::UnknownAgentType(agent) => write!(f, "Unknown agent type: {agent}"),
...
impl SettingsService {
    ...
    pub fn set_agent_env_vars(&mut self, agent_type: &str, env_vars: HashMap<String, String>) -> Result<(), SettingsServiceError> {
        match agent_type {
            ...
            _ => return Err(SettingsServiceError::UnknownAgentType(agent_type.to_string())),
        }
    ...
    pub fn set_terminal_collapsed(&mut self, is_collapsed: bool) -> Result<(), SettingsServiceError> {
        self.settings.terminal_ui.is_collapsed = is_collapsed;
        self.save()
    }
    
    pub fn set_terminal_divider_position(&mut self, position: f64) -> Result<(), SettingsServiceError> {
    ...
    pub fn set_agent_cli_args(&mut self, agent_type: &str, cli_args: String) -> Result<(), SettingsServiceError> {
        ...
        match agent_type {
            ...
            _ => {
                ...
                return Err(SettingsServiceError::UnknownAgentType(agent_type.to_string()));
            }
        }
    ...
    pub fn set_terminal_settings(&mut self, terminal: TerminalSettings) -> Result<(), SettingsServiceError> {
    ...
    pub fn set_diff_view_preferences(&mut self, preferences: DiffViewPreferences) -> Result<(), SettingsServiceError> {
    ...
    pub fn set_session_preferences(&mut self, preferences: SessionPreferences) -> Result<(), SettingsServiceError> {
    ...
    pub fn set_auto_commit_on_review(&mut self, auto_commit: bool) -> Result<(), SettingsServiceError> {
    ...
    pub fn set_agent_binary_config(&mut self, config: AgentBinaryConfig) -> Result<(), SettingsServiceError> {
    ...
    pub fn get_effective_binary_path(&self, agent_name: &str) -> Result<String, SettingsServiceError> {
