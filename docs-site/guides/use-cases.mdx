  ...
  **With Schaltwerk:**
  ...
  <Steps>
    ...
    <Step title="Launch multiple agents">
      - Session 1: Claude → Redis-based cache
  ...
  **With Schaltwerk:**
  ...
  <Steps>
    ...
    <Step title="Parallel optimization">
      - Claude optimizes API (caching, query optimization)
